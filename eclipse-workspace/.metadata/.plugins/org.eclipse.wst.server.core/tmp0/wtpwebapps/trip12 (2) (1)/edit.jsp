    ...
    <div class="container mt-5"> <!-- container 클래스 div 시작 -->
        ...
        <% 
            ...
            try {
                ...
                String query = "SELECT * FROM board WHERE id=?"; // id에 해당하는 게시글 가져오는 쿼리
        ...
        %>
        <form action="UpdateServlet" method="post" accept-charset="UTF-8"> <!-- 게시글 수정을 위한 form 태그 시작, post 방식, 문자 인코딩은 UTF-8 -->
