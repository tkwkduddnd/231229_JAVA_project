...
<body> <!-- body 태그 시작 -->
	...
	<section> <!-- section 태그 시작 -->
		<div class="user-content"> <!-- user-content 클래스 div 시작 -->
			<h2>허니문 여행</h2> <!-- 섹션 제목 설정 -->

			<form action="HoneymoonServlet" method="post"> <!-- HoneymoonServlet로 POST 방식으로 form 데이터 전송 -->
				<label for="theme"></label> <!-- 테마 라벨, 표시되는 텍스트 없음 -->
				<select name="theme"> <!-- 테마 선택 select 박스 -->
					<option value="허니문" selected>허니문</option> <!-- 기본 선택된 테마 옵션 -->
				</select> 
